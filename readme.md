...
* <sub><sup>
|  [ Qr Code Scanner ](https://github.com/industrial-edge/qr-code-scanner), [ Hello world](https://github.com/industrial-edge/hello-world), [ Developer Guide Hands on App](https://github.com/industrial-edge/Developer-Guide-Hands-on-App) | [ connectivity-tester](https://github.com/industrial-edge/connectivity-tester) | [ Apache Kafka Connector](https://github.com/industrial-edge/Apache-Kafka-Connector) | [ Grafana archiving and visualization](https://github.com/industrial-edge/archiving-and-visualization) | [ Bring own apps to shopfloor](https://github.com/industrial-edge/Bring-own-apps-to-shopfloor) | [ hello world at scale](https://github.com/industrial-edge/hello-world-at-scale) | [ upload app to iem ie app publisher cli](https://github.com/industrial-edge/upload-app-to-iem-ie-app-publisher-cli) |  [ pingpong C](https://github.com/industrial-edge/pingpong-c) | [ pingpong C#](https://github.com/industrial-edge/pingpong-csharp) | [ pingpong NodeJs](https://github.com/industrial-edge/pingpong-nodejs) | [ pingpong Python](https://github.com/industrial-edge/pingpong-python) |
</sup></sub>   
...
## Applications
### Connectivity
###### S7 Connector - [ S7 Data handling](https://github.com/industrial-edge/S7-Connector-data-handling-getting-started), [Manual](https://support.industry.siemens.com/cs/document/109823921/simatic-s7-connector-v2-0-0)
...
###### OPCUA Server - [ Opcua application](https://github.com/industrial-edge/opc-ua-application-getting-started), [Manual](https://support.industry.siemens.com/cs/document/109825264/edge-opc-ua-server-application-v2-1-2?dti=0&lc=en-US)
...
###### SLMP Connector - [Manual](https://support.industry.siemens.com/cs/document/109817632/slmp-connector-v2-1-0), [Marketplace](https://www.dex.siemens.com/edge/build-your-solution/slmp-connector), [ slmp connector getting started](https://github.com/industrial-edge/slmp-connector-getting-started)
...
### Data management
###### Databus - [Manual](https://support.industry.siemens.com/cs/document/109825263/databus-v2-3-1), [ Common databus payload format](https://github.com/industrial-edge/common-databus-payload-format)
...
###### IIH Essentials - [Manual](https://support.industry.siemens.com/cs/document/109826974/iih-essentials-for-industrial-edge), [Manual IIH](https://support.industry.siemens.com/cs/document/109826743/industrial-information-hub-v1-9), [Marketplace](https://www.dex.siemens.com/edge/build-your-solution/iih-essentials), [ data service getting started](https://github.com/industrial-edge/data-service-getting-started), [ IIH Essentials Dev kit](https://github.com/industrial-edge/iih-essentials-development-kit)
...
###### IIH Semantics - [Manual IIH](https://support.industry.siemens.com/cs/document/109826743/industrial-information-hub-v1-9), [Marketplace](https://www.dex.siemens.com/edge/build-your-solution/iih-semantics), [ iih semantics getting started](https://github.com/industrial-edge/iih-semantics-getting-started)
...
###### LiveTwin - [Manual](https://support.industry.siemens.com/cs/document/109780275/edge-livetwin-edge-app), [Marketplace](https://www.dex.siemens.com/edge/build-your-solution/livetwin), [ earthquake detection](https://github.com/industrial-edge/livetwin-earthquake-detection), [ earthquake detection Flow Creator](https://github.com/industrial-edge/livetwin-earthquake-detection-ie-fc), [ pump soft sensor](https://github.com/industrial-edge/livetwin-pump-soft-sensor)
###### Machine Insight - [Manual](https://support.industry.siemens.com/cs/document/109825693/machine-insight-application-v1-3-3), [Marketplace](https://www.dex.siemens.com/edge/build-your-solution/machine-insight), [ machine insight getting started](https://github.com/industrial-edge/machine-insight-getting-started)
###### Machine Monitor - [Manual](https://support.industry.siemens.com/cs/document/109806775/machine-monitor-for-industrial-edge),[Marketplace](https://www.dex.siemens.com/edge/build-your-solution/machine-monitor-iem), [ Machine monitor getting started](https://github.com/industrial-edge/machine-monitor-getting-started)
...
###### Performance Insight - [Manual](https://support.industry.siemens.com/cs/document/109823316/performance-insight-for-industrial-edge), [Manual UCP - Beta](https://support.industry.siemens.com/cs/document/109780761/performance-insight-v1-16-2-for-unified-comfort-panel-(beta-version-for-device-managed-ucp)), [Marketplace](https://www.dex.siemens.com/edge/build-your-solution/performance-insight), [ Performance analytics](https://github.com/industrial-edge/Performance-Analytics), [ performance insight getting started](https://github.com/industrial-edge/performance-insight-getting-started), [ Performance Insight OEE Dashboard](https://github.com/industrial-edge/Performance-Insight-OEE-Dashboard)
###### SIMATIC Automation Tool - [Manual](https://support.industry.siemens.com/cs/document/109795199/simatic-automation-tool-online-help), [Marketplace](https://www.dex.siemens.com/edge/build-your-solution/simatic-automation-tool-freemium), [ simatic automation tool getting started](https://github.com/industrial-edge/simatic-automation-tool-getting-started)
###### SIMATIC WinCC Unified Online Engineering - [Manual](https://support.industry.siemens.com/cs/document/109800802/simatic-hmi-wincc-unified-visualizing-processes-with-wincc-unified-online-engineering), [Marketplace](https://www.dex.siemens.com/edge/build-your-solution/simatic-wincc-unified-online-engineering), [ Wincc Unified on IE](https://github.com/industrial-edge/wincc-unified-on-IE)
###### SIMATIC WinCC Unified Runtime - [Manual](https://support.industry.siemens.com/cs/document/109825694/wincc-unified-runtime-for-industrial-edge-v2-1-0), [Marketplace](https://www.dex.siemens.com/edge/build-your-solution/simatic-wincc-unified-runtime), [ Wincc Unified on IE](https://github.com/industrial-edge/wincc-unified-on-IE)
...
###### Tank Application sample project - [ Tank Application Sample Project](https://github.com/industrial-edge/miscellaneous)
###### Profibus - [ profibus to edge connection getting started](https://github.com/industrial-edge/profibus-to-edge-connection-getting-started)
###### Simotion - [ simotion trace connector getting started](https://github.com/industrial-edge/simotion-trace-connector-getting-started)
